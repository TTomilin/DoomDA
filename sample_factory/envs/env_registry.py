...
def box2d_funcs():
    from sample_factory.envs.box2d.box2d_utils import make_box2d_env
    from sample_factory.envs.box2d.box2d_params import box2d_override_defaults
    return make_box2d_env, None, box2d_override_defaults
