...
from vizdoom import ScreenResolution, DoomGame, Mode, AutomapMode
...
class VizdoomEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.scenario = config_file.split('/')[0]
        ...
        self.scenario_path = join(scenarios_dir, self.scenario, f'{task}.wad')
