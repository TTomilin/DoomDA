...
def add_doom_env_args(env, parser):
    ...
    p.add_argument('--task', type=str, default='default', help='Name of the training task, e.g. flying_enemies, mancubus, resized_shaded_kits')
    p.add_argument('--eval_tasks', type=str, default=[], nargs='*', help='Evaluation task names, e.g. red_mixed_enemies resized_shadows_invulnerable')
    # p.add_argument('--record_to', default=join(os.getcwd(), '..', 'recs'), type=str, help='Record episodes to this folder')
    p.add_argument('--record_to', default=None, type=str, help='Record episodes to this folder')
