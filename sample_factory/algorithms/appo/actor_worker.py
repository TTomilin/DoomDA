...
class ActorState:
    ...
    def record_env_step(self, reward, done, info, rollout_step):
        ...
        # TODO add movement for seek_and_kill
        ...
        if done:
            ...
            # TODO Refactor to Doom environments only
            if 'KILLCOUNT' in info:
                report['episodic']['kill_count'] = info['KILLCOUNT']
            if 'AMMO2' in info:
                report['episodic']['ammo_left'] = info['AMMO2']
